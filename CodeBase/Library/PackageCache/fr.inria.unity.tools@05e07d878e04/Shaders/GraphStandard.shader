Shader "Tools/Graph Standard"
{
	Properties
	{
		...
		_GoodThreshold("Good Threshold", Float) = 0.25
		_CautionThreshold("Caution Threshold", Float) = 0.5
	}
		...
		SubShader
		{
			...
			Pass
			{
				...
				uniform float GraphValues[1024];
